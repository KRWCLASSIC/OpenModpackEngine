...
OpenModpackEngine is a batch script to install, manage and distribute modpacks without the need for external/closed source applications/sites like CurseForge.
